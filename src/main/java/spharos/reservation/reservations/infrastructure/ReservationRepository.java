...
//                                                   @Param("state") ReservationStatus state,
//                                                   Pageable pageable);
//
//
...
//    List<Reservation> findByReservationStatusWait(@Param("serviceId") Long serviceId, @Param("reservationState") ReservationStatus reservationState);
